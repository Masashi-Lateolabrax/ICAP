...
class World:
    ...
    @classmethod
    def _create(cls, model: mujoco.MjModel, dummies: list[DummyGeom], timer: WorldClock):
        instance = cls.__new__(cls)
        instance.__init_instance(model, dummies, timer)
        return instance

    def __init_instance(self, model: mujoco.MjModel, dummies: list[DummyGeom], timer: WorldClock):
        self.model = model
