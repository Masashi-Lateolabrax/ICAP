...
from scheme.transportation_with_pheromone.lib.objects.robot import RobotBuilder, Robot
from scheme.transportation_with_pheromone.lib.parts import BrainInterface, BrainJudgement
