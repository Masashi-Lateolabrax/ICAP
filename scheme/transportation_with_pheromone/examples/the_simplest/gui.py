...
class SimulationManager:
    ...
    def __init__(self, settings: framework.Settings, task: optimizer.MjcTaskInterface):
...
class App(tk.Tk):
    def __init__(self, settings: framework.Settings, task: optimizer.MjcTaskInterface, max_geom):
        super().__init__()
