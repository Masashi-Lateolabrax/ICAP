    ...
    generator = mjc_gen.Generator().add_children([
        ...
        Asset().add_children([
            ...
            asset.Material(
                ...
                texrepeat=(
                    int(Settings.Structure.Environment.WIDTH / 2),
                    int(Settings.Structure.Environment.HEIGHT / 2)
                )
            )
        ])
    ])

    tile_size = Settings.Structure.Environment.CELL_SIZE
    env_width = Settings.Structure.Environment.WIDTH * tile_size
    env_height = Settings.Structure.Environment.HEIGHT * tile_size
    ...
    for i, p in enumerate(Settings.Task.Robot.POSITIONS):
        ...
        worldbody.add_children([
            Body(
                ...
                body.Site(type_=mjc_cmn.GeomType.SPHERE, size=(0.04,)),
