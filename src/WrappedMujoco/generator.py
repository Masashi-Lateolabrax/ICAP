...
class MuJoCoXMLGenerator:
    ...
    class MuJoCoCompiler(_ToString):
        def __init__(self):
            pass
    ...
    class MuJoCoStatistic(_ToString):
        def __init__(self):
            pass
    ...
    class MuJoCoEquality(_ToString):
        def __init__(self):
            pass
    ...
    class MuJoCoActuator(_ToString):
        def __init__(self):
            self.general = []
            self.motor = []
            self.position = []
    ...
    class MuJoCoKeyframe(_ToString):
        def __init__(self):
            pass
    ...
    def __init__(self, model_name: str):
        ...
        self.elements: list[MuJoCoXMLGenerator._ToString] = list([MuJoCoXMLGenerator.MuJoCoBody(True, {})])
